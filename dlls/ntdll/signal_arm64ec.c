...
DEFINE_SYSCALL(NtQueryWnfStateData, (const void *state_name, const void *type_id, const void *scope, ULONG *change_stamp, void *buffer, ULONG *size))
...
DEFINE_SYSCALL(NtSubscribeWnfStateChange, (const void *state_name, ULONG change_stamp, ULONG flags, ULONG *subscription_id, void *unknown))
...
DEFINE_SYSCALL(NtUpdateWnfStateData, (const void *state_name, const void *buffer, ULONG length, const void *type_id, const void *scope, ULONG match_stamp, ULONG check_stamp))
