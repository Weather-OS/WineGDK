...
static inline struct x_user *impl_from_IXUserDevice2( IXUserDeviceImpl2 *iface )
{
...
static const struct IXUserDeviceImpl2Vtbl x_user_device_vtbl =
{
    ...
    /* IXUserDevice/IXUserDeviceImpl2 methods */
...
IXUserImpl6 *x_user_impl = &x_user.IXUserImpl6_iface;
IXUserDeviceImpl2 *x_user_device_impl = &x_user.IXUserDeviceImpl2_iface;
