...
{
    LPCWSTR property_set_str = RuntimeClass_Windows_Foundation_Collections_PropertySet;
    ...
    *instance = NULL;
    ...
    WindowsCreateStringReference( property_set_str,
                                  wcslen( property_set_str ), &header, &property_set_class );
    if (FAILED(hr = RoActivateInstance( property_set_class, (IInspectable**)&property_set )))
    {
        free( impl );
        return hr;
    }
