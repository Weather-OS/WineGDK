...
HRESULT WINAPI GameInputInitialize( void *version_data, v0_IGameInput **out )
{
    TRACE( "version_data %p, out %p (forwarding to GameInputCreate)\n", version_data, out );
    return GameInputCreate( out );
}
