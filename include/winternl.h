...
NTSYSAPI NTSTATUS  WINAPI NtQueryWnfStateData(const void*,const void*,const void*,ULONG*,void*,ULONG*);
...
NTSYSAPI NTSTATUS  WINAPI NtSubscribeWnfStateChange(const void*,ULONG,ULONG,ULONG*,void*);
...
NTSYSAPI NTSTATUS  WINAPI NtUpdateWnfStateData(const void*,const void*,ULONG,const void*,const void*,ULONG,ULONG);
